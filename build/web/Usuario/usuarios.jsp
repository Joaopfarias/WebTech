    ...
    <body>
        ...
        <%
            try {
                ...
                out.print("<tr>");
                out.print("<th>RGM</th><th>Nome</th><th>E-mail</th><th>Senha</th><th>Tipo Usuário</th><th>Curso</th><th>Editar</th><th>Deletar</th>");
                out.print("</tr>");
                usuarioDAO usd = new usuarioDAO();
                ArrayList<Usuario> lista = usd.listarTodos();
                for (int num = 0; num < lista.size(); num++) {
                    String tipou = lista.get(num).getTipoUsuario();
                    if (tipou.equals("Aluno")) {
                        ...
                        out.print("</tr>");
                    } else if (tipou.equals("Administrador de Sistemas") || tipou.equals("Professor")) {
                        out.print("<tr>");
                        out.print("<td>" + lista.get(num).getRGM() + "</td>");
                        out.print("<td>" + lista.get(num).getNome() + "</td>");
                        out.print("<td>" + lista.get(num).getEmail() + "</td>");
