    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse text-right" id="navbarToggleExternalContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="disciplina.jsp">Disciplinas</a>
                    </li>
        ...
        <%
            try
            {
             ...
             out.print("<tr>");
             out.print("<th>Nome</th><th>Carga horária</th><th>Curso</th>");
             out.print("</tr>");
             disciplinaDAO dsp = new disciplinaDAO();
             ArrayList<Disciplina> lista = dsp.listarTodasDscp();
