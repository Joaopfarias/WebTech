        ...
        <div class="container-fluid mb-3">
            <form action="criarUsuario.jsp" method="post"  class="alert alert-primary bg-light">
                ...
                <div class="form-row">
                    <div class="col-md-6">
                        Nome:<br/><br/>
                        <input type="text" name="txtnome" placeholder="Digite seu nome" required="required" class="form-control"/>
                    </div>
                    <div class="col-md-6">
                        E-mail:<br/><br/>
                        <input type="email" name="txtemail" placeholder="Digite seu e-mail" required="required" class="form-control"/><br/><br/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3">
